...
delete a Dynamic field value entry. All associated rows will be deleted.
    ...
    Returns 1.
*/
func ValueDelete(fieldID int, objectID int64) {
...
*/
func ValueGet(fieldID int, objectID int64) (values []model.DynamicFieldValue) {
	// get cache object
...
func ValueSet(fieldID int, objectID int64, values []model.DynamicFieldValue) {
